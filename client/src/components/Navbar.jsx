        ...
        className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
            <div className='flex items-center gap-8'>
                ...
                <div className='hidden md:flex items-center gap-6 text-sm font-medium text-gray-500'>
                    <button onClick={() => navigate("/")} className='hover:text-black transition cursor-pointer font-medium'>Mock Interview</button>
                    <button onClick={() => navigate("/ats-analyzer")} className='hover:text-black transition cursor-pointer font-medium'>ATS Analyzer</button>
                    <button onClick={() => navigate("/history")} className='hover:text-black transition cursor-pointer font-medium'>Analytics & History</button>
                </div>
            </div>
