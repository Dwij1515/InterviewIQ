...
Calculate a match score (0 to 100), identify matched keywords, identify missing keywords, write a brief match explanation, and list actionable optimization tips.
...
Return strictly a JSON object conforming to this schema:
{
  ...
  "resumeOptimizations": ["Actionable tip 1", "Actionable tip 2"]
}
`
      },
      {
    ...
    return res.status(500).json({ message: error.message || "Failed to analyze ATS compatibility" });
  }
};
